var jsTweetBox = function(){
  ...
  initAnywhere = function(T){
   $T = T;	
   $twtBox = $("#js-tweet-box");	
	$twtBox.append("<div class='js-sidebar'></div><div class='js-reactions'>Publicar un nuevo Tweet<textarea name='js-tweet-box' rows='4' cols='50'></textarea>"
		 + "<div style='text-align: center;'>"
	    + "<div class='js-tweet-count'>140</div>"
	    + "<div class='js-tweet-button button'>Twittear</div>"
  ...
  processRecentTweets = function(json){
	if (json.results.length > 0) {
   	var $recentTweets = $("<div class='js-recent-tweets'><h1>Nuevos Tweets <span>en 4 dias</span></h1></div>"), 
		$status,
		curStatus;
...
//		tweetBox.setReply(replyID, userReply);
  ...
  addFollowMe = function(user){
	...
	if($pub.following){
		...
		$followButton.attr("title", "Seguir " + $pub.screenName + " en Twitter");
		$followButton.click(followPublisher);
		$followButton.html("Seguir");
	}
