$(function(){var pull=$('#pull');menu=$('.mainnav');menuHeight=menu.height();$(pull).on('click',function(e){e.preventDefault();menu.slideToggle()})});$(document).ready(function(){$('#mainmenu li a').each(function(index){if(this.href.trim()==window.location)$(this).addClass("selected")})});
...
jQuery(document).ready(function(){jQuery('a[href*="http://"]:not([href*="http://www.laverdadoculta.com.ar/"])').attr('rel','nofollow');jQuery('a[href*="http://"]:not([href*="http://www.laverdadoculta.com.ar/"])').attr("target","_blank")});

function addLink() {
var body_element = document.getElementsByTagName('body')[0];
var selection;
selection = window.getSelection();
var pagelink = "<br/><br/> Texto completo en: <a href='"+document.location.href+"'>"+document.location.href+"</a>"; var copytext = selection + pagelink;
