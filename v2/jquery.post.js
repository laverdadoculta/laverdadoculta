...
$activeTab=$(strDefault);$activeTab.removeClass("js-inactive-tab");$activePage=$(strDefault+"-page");$activePage.show();},function(json){$count.text(json.count);$count=null;});});},selectPage=function(){$activeTab.addClass("js-inactive-tab");$activeTab=$(this);$activeTab.removeClass("js-inactive-tab");$activePage.hide();$activePage=$("#"+$activeTab.attr("id")+"-page");$activePage.show();};$("head").append("<link id='js-comments-pages-styles' rel='stylesheet' type='text/css' href='http://laverdadoculta.googlecode.com/svn/trunk/commentpages/jsCommentPages.css'/>");$("document").ready(init);}();